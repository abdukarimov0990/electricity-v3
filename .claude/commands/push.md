---
description: Commits and pushes the electricity-v3 changes to GitHub
...
Single repo: `electricity-v3` (Next.js 16 + React 19 + Tailwind 4 + Prisma 7 + PostgreSQL), remote `origin` -> `github.com/yaxyobekuz/electricity-v3`.
